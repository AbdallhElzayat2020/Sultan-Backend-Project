                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-check form-switch d-flex align-content-center  gap-3 mb-5 ">
                                        <input class="form-check-input fs-large" name="status" value="active"
                                               @checked(old('status', $service->status->value) === \App\Enums\Status::ACTIVE->value)
                                               type="checkbox"
                                               id="blog">
                                        ...
                                        <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                                            <div class="my-3 col-12 col-md-6">
                                                ...
                                                <input type="text" name="title[ar]" class="form-control"
                                                       ...
                                                       value="{{ old('title.ar', $service->translate('title', 'ar')) }}"
                                            ...
                                            <div class="form-group my-3">
                                                ...
                                                <textarea class="form-control" name="short_description[ar]"
                                                          ...
                                                          cols="30"
                                                          rows="5">{{ old('short_description.ar', $service->translate('short_description', 'ar')) }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description[ar]"
                                                          id="description_ar"
                                                          cols="30"
                                                          rows="10">{{ old('description.ar', $service->translate('description', 'ar')) }}</textarea>
                                            </div>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($service->features as $feature)
                                                            <tr x-data>
                                                                <td>
                                                                    <input type="text"
                                                                           name="features[{{$loop->index}}][ar]"
                                                                           class="form-control border-0 shadow-none"
                                                                           placeholder="ادخل الميزه"
                                                                           value="{{ $feature->translate('feature', 'ar') }}"
                                                        ...
                                                        <template x-for="(feature, index) in features" :key="index">
                                                            <tr>
                                                                <td>
                                                                    <input type="text"
                                                                           :name="`features[${index + featuresCount}][ar]`"
                                                                           class="form-control border-0 shadow-none"
                                                                           placeholder="ادخل الميزه"
                                        ...
                                        <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                                            <div class="my-3 col-12 col-md-6">
                                                ...
                                                <input type="text" name="title[en]" class="form-control"
                                                       value="{{ old('title.en', $service->translate('title', 'en')) }}"
                                            ...
                                            <div class="form-group my-3">
                                                ...
                                                <textarea class="form-control" name="short_description[en]"
                                                          ...
                                                          cols="30"
                                                          rows="5">{{ old('short_description.en', $service->translate('short_description', 'en')) }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description[en]"
                                                          id="description_en"
                                                          cols="30"
                                                          rows="10">{{ old('description.en', $service->translate('description', 'en')) }}</textarea>
                                            </div>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($service->features as $feature)
                                                            <tr x-data>
                                                                <td>
                                                                    <input type="text"
                                                                           name="features[{{$loop->index}}][en]"
                                                                           class="form-control border-0 shadow-none"
                                                                           placeholder="ادخل الميزه"
                                                                           value="{{ $feature->translate('feature', 'en') }}"
                                                                           aria-describedby="feature text"/>
                                                                </td>
                                                                <td style="width: 25px">
                                                                    <button class="btn btn-danger" type="button"
                                                        ...
                                                        <template x-for="(feature, index) in features" :key="index">
                                                            <tr>
                                                                <td>
                                                                    <input type="text"
                                                                           :name="`features[${index + featuresCount}][en]`"
                                                                           class="form-control border-0 shadow-none"
                                                                           placeholder="ادخل الميزه"
                                                                           x-model="features[index].name"
                                                                           aria-describedby="feature text"/>
